  ...
  return (
    ...
    <div className="flex flex-col items-center justify-around min-h-screen w-full bg-[rgba(249,249,250,1)] p-6">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-2 gap-2 text-center">
          <h1 className="font-medium text-[rgba(33,33,33,1)] text-3xl">{formType === "signup" ? "BECOME AN EXCLUSIVE MEMBER" : "WELCOME BACK EXCLUSIVE MEMBER"}</h1>
          <small className="text-[rgba(66,66,66,1)] text-lg ">{formType === "signup" ? "SIGN UP AND JOIN THE PARTNERSHIP" : "LOGIN TO CONTINUE"}</small>
        </div>

        {formType === "signup" && (
          <div className="relative">
            <BiUser className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[rgba(66,66,66,1)]" size={20} />
            <input
              type="text"
              ...
              className="py-3 pr-22 pl-8 text-[rgba(66,66,66,1)] border rounded-lg outline-none"
            />
          </div>
        )}

          <div className="relative">
          <BiEnvelope className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[rgba(66,66,66,1)]" size={20} />
            <input
              type="email"
          ...
          <div className="relative">
          <BiLock className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[rgba(66,66,66,1)]" size={20} />
            <input
            ...
            {showPassword ? (
              <BiHide
                className="absolute right-3.5 top-1/2 -translate-y-1/2 cursor-pointer text-[rgba(66,66,66,1)]"
                size={20}
